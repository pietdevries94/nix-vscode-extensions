  ...
  extra-vscode-extensions = {
    ...
    github.vscode-pull-request-github = buildVscodeMarketplaceExtension {
      mktplcRef = {
        ...
        sha256 = "1d6dph04mqikdpm8fa9bva31ah9g6c7aqz8kg29w18h9r74g2ga6";
      };
    };
    ...
    matklad.rust-analyzer = buildVscodeMarketplaceExtension {
      mktplcRef = {
        ...
        publisher = "matklad";
        version = "0.3.1005";
        sha256 = "0fywlgw29nvkw8vkzhrsz6399jxczi1jy8kxblsnlh5bm8vpl797";
      };
    };
    ...
    znck.vue-language-features = buildVscodeMarketplaceExtension {
      mktplcRef = {
        ...
        publisher = "znck";
        version = "0.9.24";
        sha256 = "1iawgc0ap9sy3acamfgdabp60jrjd76frzjh19kdkp6bsq21g7vg";
      };
    };
  };
}
