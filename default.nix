  ...
  extra-vscode-extensions = {
    ...
    github.vscode-pull-request-github = buildVscodeMarketplaceExtension {
      mktplcRef = {
        ...
        publisher = "github";
        version = "0.35.2022012509";
        sha256 = "1mqsbfafp81s6gw7849pp5dvr9mcklf8kigz7jmq1ih9cv0gillf";
      };
    };
    ...
    matklad.rust-analyzer = buildVscodeMarketplaceExtension {
      mktplcRef = {
        ...
        publisher = "matklad";
        version = "0.3.918";
        sha256 = "0arqwf3mxzk43wimnijybzj7wfhx9aalf71ii7ycfsjcqs66r3bi";
      };
    };
    ...
    voorjaar.windicss-intellisense = buildVscodeMarketplaceExtension {
      mktplcRef = {
        ...
        publisher = "voorjaar";
        version = "0.21.6";
        sha256 = "1s6klwcpgq3jc6c9dlny86wn4657ryiz6bld32i2b9gdmisjqa25";
      };
    };
